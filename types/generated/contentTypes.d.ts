...
export interface ApiBookkeepingBookkeeping extends Schema.CollectionType {
...
export interface ApiBrandGuidlineBrandGuidline extends Schema.CollectionType {
  collectionName: 'brand_guidlines';
  info: {
    singularName: 'brand-guidline';
    pluralName: 'brand-guidlines';
    displayName: 'Brand Guidline';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::brand-guidline.brand-guidline',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiCaseStudieCaseStudie extends Schema.CollectionType {
...
export interface ApiClientClient extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    slug: Attribute.String & Attribute.Required & Attribute.Unique;
    cliendLogo: Attribute.Media & Attribute.Required;
    ClientInformation: Attribute.Text & Attribute.Required & Attribute.Unique;
    ClientInformationSummary: Attribute.Text & Attribute.Required;
    email: Attribute.Email & Attribute.Required;
    Active: Attribute.Boolean & Attribute.Required;
    phoneNumber: Attribute.Integer & Attribute.Required;
...
export interface ApiInvoiceInvoice extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    slug: Attribute.String & Attribute.Required & Attribute.Unique;
    PaidAndOutstanding: Attribute.Boolean & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ProjectStatues: Attribute.Enumeration<['morning', 'noon ', 'evening']> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProposalProposal extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    slug: Attribute.String & Attribute.Required & Attribute.Unique;
    AprovedPending: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    service_pack: Attribute.Relation<
      'api::service.service',
      'manyToOne',
      'api::service-pack.service-pack'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiServicePackServicePack extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::brand-guidline.brand-guidline': ApiBrandGuidlineBrandGuidline;
      ...
      'api::service-pack.service-pack': ApiServicePackServicePack;
    }
  }
}
